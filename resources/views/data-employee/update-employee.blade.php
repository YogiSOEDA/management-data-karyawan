        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="card card-primary card-outline">
                    <form action="{{ url('data-karyawan/'.$data->id.'/update') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    placeholder="Masukkan Nama Karyawan" value="{{ $data->name }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="join_date" id="join_date"
                                    placeholder="Masukkan Tanggal Bergabung" value="{{ $data->join_date }}" required>
                            </div>
                            <div class="form-group">
