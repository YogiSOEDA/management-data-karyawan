...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/dashboard/tabel', [DashboardController::class, 'table']);
    Route::get('/dashboard/filter-date', [DashboardController::class, 'filterDataDateRange']);
    ...
    Route::get('/data-jabatan', [PositionController::class, 'index'])->name('position');
    ...
    Route::get('/data-karyawan', [UserController::class, 'index'])->name('employee');
